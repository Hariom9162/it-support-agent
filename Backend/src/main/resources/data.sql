INSERT IGNORE INTO knowledge_base (kb_code, title, content)
VALUES
(
    'KB-01',
    'Password Reset',
...
(
    ...
    'Employees working remotely more than 3 days per week are eligible for a one-time home office equipment allowance including chair and monitor. Requires manager sign-off and Finance processing. IT only handles the equipment shipping request once approved.'
),
(
    'ASSET-POLICY',
...
INSERT IGNORE INTO employee_requests
(request_id, employee_name, email, date_opened, request_text, initial_action)
VALUES
...
('REQ-15',
 ...
 (ticket_id, employee, issue_summary, status)
 VALUES
